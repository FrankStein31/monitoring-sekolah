                    ...
                    @if ($guru->dsk($guru->id))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" required name="predikat_a" id="predikat_a" rows="4">@isset($nilai){{ $nilai->deskripsi_a }}@endisset</textarea>
                            </div>
                            <div class="form-group">
                                <label for="predikat_c">Predikat C</label>
                                <textarea class="form-control" required name="predikat_c" id="predikat_c" rows="4">@isset($nilai){{ $nilai->deskripsi_c }}@endisset</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return inputAngka(event)" maxlength="2" value="@isset($nilai){{ $nilai->kkm }}@endisset" id="kkm" name="kkm" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="predikat_b">Predikat B</label>
                                <textarea class="form-control" required name="predikat_b" id="predikat_b" rows="4">@isset($nilai){{ $nilai->deskripsi_b }}@endisset</textarea>
                            </div>
                            <div class="form-group">
                                <label for="predikat_d">Predikat D</label>
                                <textarea class="form-control" required name="predikat_d" id="predikat_d" rows="4">@isset($nilai){{ $nilai->deskripsi_d }}@endisset</textarea>
                            </div>
                        </div>
                    @else
                        <div class="col-md-6">
