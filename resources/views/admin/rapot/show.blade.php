                    ...
                    <tbody>
                            @foreach ($mapel as $val => $data)
                                ...
                                <tr>
                                    ...
                                    @endphp
                                    <td class="ctr">{{ $rapot ? $rapot['p_nilai'] : '-' }}</td>
                                    <td class="ctr">{{ $rapot ? $rapot['p_predikat'] : '-' }}</td>
                                    <td class="ctr">{{ $rapot ? $rapot['p_deskripsi'] : '-' }}</td>
                                    <td class="ctr">{{ $rapot ? $rapot['k_nilai'] : '-' }}</td>
                                    <td class="ctr">{{ $rapot ? $rapot['k_predikat'] : '-' }}</td>
                                    <td class="ctr">{{ $rapot ? $rapot['k_deskripsi'] : '-' }}</td>
                                </tr>
                            @endforeach
                    </tbody>
                </table>
