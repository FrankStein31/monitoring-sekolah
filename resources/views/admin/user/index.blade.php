            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group" id="usernameField" style="display: none;">
                  ...
                  <input id="name" type="text" placeholder="Username" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="off">
                  @error('name')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
    ...
    $(document).ready(function(){
        $('#role').change(function(){
            ...
            if (role == "Guru") {
              ...
              $("#usernameField").hide();
            } else if(role == "Admin" || role == "Kepala Sekolah") {
