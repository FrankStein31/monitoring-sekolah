                            ...
                            @foreach ($mapel as $val => $data)
                                ...
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $ulangan = $data->cekUlangan($jsonData);
                                    @endphp
                                    <td class="ctr">{{ $ulangan ? $ulangan['ulha_1'] : '-' }}</td>
                                    <td class="ctr">{{ $ulangan ? $ulangan['ulha_2'] : '-' }}</td>
                                    <td class="ctr">{{ $ulangan ? $ulangan['uts'] : '-' }}</td>
                                    <td class="ctr">{{ $ulangan ? $ulangan['ulha_3'] : '-' }}</td>
                                    <td class="ctr">{{ $ulangan ? $ulangan['ulha_4'] : '-' }}</td>
                                    <td class="ctr">{{ $ulangan ? $ulangan['uas'] : '-' }}</td>
                                </tr>
                            @endforeach
                    </tbody>
                </table>
