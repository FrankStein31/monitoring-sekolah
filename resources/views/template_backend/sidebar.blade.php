...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link" style="">
        <img src="{{ asset('img/tutwurihandayani.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
                ...
                @elseif (Auth::user()->role == 'Guru' && Auth::user()->guru(Auth::user()->id_card))
                    ...
                    <li class="nav-item has-treeview" id="liNilaiGuru">
                        ...
                        <ul class="nav nav-treeview ml-4">
                            ...
                            @if (
                                Auth::user()->guru(Auth::user()->id_card)->mapel->nama_mapel == "Agama" ||
                                Auth::user()->guru(Auth::user()->id_card)->mapel->nama_mapel == "PPKN - Pendidikan Pancasila dan Kewarganegaraan"
                            )
                                <li class="nav-item">
